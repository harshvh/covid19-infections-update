...
# p1 := P(S|tested)
samp_p1 <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0.3,b = 1,
                    shape1 = find_beta_shape_params(mu = 0.8, sd = (0.3)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.8, sd = (0.3)^2)$b)
}

# p2 := P(S|untested)
samp_p2 <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0,b = 0.25,
                    shape1 = find_beta_shape_params(mu = 0.08, sd = (0.3)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.08, sd = (0.3)^2)$b)
}
...
samp_za <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0,b = 0.55,
...
dist_Se = truncdist::rtrunc(n = 100000,spec = "beta",a = 0.7,b = 1,
                            shape1 = find_beta_shape_params(mu = 0.92, sd = (0.3)^2)$a,
                            shape2 = find_beta_shape_params(mu = 0.92, sd = (0.3)^2)$b)
...
##############################################
p0 <- function(x){
  truncdist::dtrunc(x = x,spec = "beta",a = 0.15,b = 0.5,
                    shape1 = find_beta_shape_params(mu = 0.25, sd = (0.25)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.25, sd = (0.25)^2)$b)
}
