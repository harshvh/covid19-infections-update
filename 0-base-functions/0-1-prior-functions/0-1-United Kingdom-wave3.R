...
# Prior Functions #
# United Kingdom
# Wave 3 - 01.11.2020 to 28.02.2021
...
samp_p1 <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0.6,b = 1,
                    shape1 = find_beta_shape_params(mu = 0.8, sd = (0.25)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.8, sd = (0.25)^2)$b)
}

# p2 := P(S|untested)
samp_p2 <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0.05,b = 0.5,
                    shape1 = find_beta_shape_params(mu = 0.1, sd = (0.25)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.1, sd = (0.25)^2)$b)
}

# Z_s := adjustment factor for P(test +|S) among untested (alpha)
samp_zs <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0.5,b = 0.75,
...
samp_za <- function(n){
  truncdist::rtrunc(n = n,spec = "beta",a = 0.07,b = 0.5,
                    shape1 = find_beta_shape_params(mu = 0.2, sd = (0.2)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.2, sd = (0.2)^2)$b)
}
...
dist_Se = truncdist::rtrunc(n = 100000,spec = "beta",a = 0.85,b = 1,
                            shape1 = find_beta_shape_params(mu = 0.93, sd = (0.3)^2)$a,
                            shape2 = find_beta_shape_params(mu = 0.93, sd = (0.3)^2)$b)
...
##############################################
p0 <- function(x){
  truncdist::dtrunc(x = x,spec = "beta",a = 0.25,b = 0.5,
                    shape1 = find_beta_shape_params(mu = 0.4, sd = (0.025)^2)$a,
                    shape2 = find_beta_shape_params(mu = 0.4, sd = (0.025)^2)$b)
}
