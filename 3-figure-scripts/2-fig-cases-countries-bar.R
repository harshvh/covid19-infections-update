...
############################################################
### save separate plots
ggsave(nat_bar_solo, filename = paste0(plot_path, "fig-countries-cases-bar-obs.png"),
       width=8, height=7)

ggsave(perdiff_solo_plot, filename = paste0(plot_path, "fig-countries-cases-bar-ratio.png"),
       width=8, height=7)
...
### save separate interactive plots  --- needed?
saveWidget(nat_bar_solo_int, paste0(plot_path, "fig-countries-cases-bar-obs.html"), selfcontained = T)
saveWidget(perdiff_solo_plot_int, paste0(plot_path, "fig-countries-cases-bar-ratio.html"), selfcontained = T)
